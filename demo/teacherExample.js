window.onload = function () {
  ...
  function defaultControlState() {
    ...
    document.querySelector(".screen-share > svg:nth-child(2)").style.display =
      "block";
    document.querySelector(".screen-share > svg:nth-child(1)").style.display =
      "none";
    ...
    document.querySelector(".content-view > svg:nth-child(1)").style.display =
      "block";
    document.querySelector(".content-view > svg:nth-child(2)").style.display =
      "none";
